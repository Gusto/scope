...
use dx_scope::{
    CONFIG_FILE_PATH_ENV, CaptureOpts, FoundConfig, OutputCapture, OutputDestination,
    RUN_ID_ENV_VAR, analyze_root, doctor_root, lint_root, print_details, report_root,
    report_stdout,
};
